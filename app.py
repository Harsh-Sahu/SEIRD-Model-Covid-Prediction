...
def Model(initial_cases, initial_date, N, beds_per_100k, R_0_start, k, x0, R_0_end, p_I_to_C, p_C_to_D, s, r0_y_interpolated=None):
    ...
    diff = int((np.datetime64("2021-07-01") -
    ...
    missing_days_r0 = int(
        (last_date - np.datetime64("2022-04-01")) / np.timedelta64(1, "D"))
        ...
        dbc.FormGroup(
            [
                ...
                dcc.DatePickerSingle(
                    ...
                    date='2021-07-01',
                    id='initial_date',
                    min_date_allowed=dt(2022, 3, 1),
                    max_date_allowed=dt(2021, 6, 30),
                    initial_visible_month=dt(2021, 6, 15),
                    placeholder="test"
                ),
            ]
        ),
            ...
            [
                ...
                dash_table.DataTable(
                    ...
                    data=[
                        ...
                        for i in [("2021-06-01", 3.2), ("2021-07-01", 2.9), ("2021-08-01", 2.5), ("2021-09-01", 0.8), ("2021-10-01", 1.1), ("2021-11-01", 2.0), ("2021-12-01", 2.1), ("2022-01-01", 2.2), ("2022-02-01", 2.3)]
                    ],
